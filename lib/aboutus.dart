...
class _Constants {
  ...
  static const String bibleReference =
      'የሐዋርያው የቅዱስ ጳዉሎስ መልእክት ወደ ቆላስይስ ሰዎች 3:23';
  ...
  static const List<List<String>> contributors = [
    ...
    ['• ለሳሮን ቴሜሳ', '• ለአይዳ ያቦነህ'],
    ['• ለበረከት ታደሰ', '• ለእዮብ ዘውዱ'],
    ['• ለልደት ዳዊት', '• ለኑሐሚን ወንድወሰን'],
    ['• ለእንየው ወንድማገኝ', '• ለመምህር ምናልባት ደስታ'],
    ['• ለዮዲት አማኑኤል', '• ለሜላት አምሳሉ'],
  ];

  static const String closingAcknowledgement =
      'እንዲሁም በዚህ ስራ ላይ በግልፅም ሆነ በህቡዕ ለተሳተፋችሁ ሁሉ ዓምደ ሃይማኖት ሰንበት ትምህርት ቤት ምስጋናዋን ታቀርባለች!\n'
      'እግዚአብሔር አምላክ አገልግሎታችሁን ይባርክላችሁ!';

  static const String specialThanks =
      '° ለዲ/ን ዳዊት ተመስገን(ዘልደታ) : በጅማ ዩኒቨርስቲ (JIT) የ 2ኛ ዓመት የኮምፒውተር ሳይንስ ተማሪ, ይህን አኘልኬሽን በመስራት ከፍፃሜ እንዲደርስ ላበረከትከው የላቀ አስተዋፅኦ እግዚአብሔር የሰማዩን ዋጋ ያድልህ ! ላደረከዉ አስተዋጽኦ እናት ሰንበት ት/ቤትህ ምስጋናዋን ታቀርባለች \n\n'
  ...
  static const String copyrightNotice =
      'ጅማ ዓምደ ሃይማኖት ሰንበት ትምህርት ቤት. All Rights Reserved.';
  ...
  static const String tiktokUrl =
      'https://www.tiktok.com/@jimaamdehaymanotsunday?_t=ZM-8xGyYrCWeOe&_r=1';
}
...
class AboutUsBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color accentColor =
        isDarkMode ? const Color(0xFFF3BD46) : theme.primaryColor;

    return SingleChildScrollView(
      padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 24.0),
      child: Column(
        children: [
          _BibleVerseCard(accentColor: accentColor),
          const SizedBox(height: 30),
          _SocialMediaSection(onLaunch: (url) => _launchUrl(context, url)),
          const SizedBox(height: 30),
          _AcknowledgementsCard(),
          const SizedBox(height: 20),
          _SpecialThanksCard(accentColor: accentColor),
          const SizedBox(height: 20),
...
class AboutUsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color accentColor =
        isDarkMode ? const Color(0xFFF3BD46) : theme.primaryColor;
    final Color appBarIconColor = isDarkMode ? accentColor : Colors.white;
    final Color appBarBgColor =
        isDarkMode ? const Color(0xFF1E1E2D) : const Color(0xFF1E1E1E);

    return Scaffold(
      appBar: AppBar(
        title: Text('ስለ እኛ', style: TextStyle(color: appBarIconColor)),
...
class _BibleVerseCard extends StatelessWidget {
  const _BibleVerseCard({required this.accentColor});
  final Color accentColor;
...
class _SocialButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return IconButton(
      ...
      splashRadius: 28,
      tooltip: 'Visit our social media',
    );
  }
}
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              _Constants.closingAcknowledgement,
              style: textTheme.bodyMedium?.copyWith(
                height: 1.5,
                color: theme.colorScheme.onSurfaceVariant,
              ),
...
class _SpecialThanksCard extends StatelessWidget {
  const _SpecialThanksCard({required this.accentColor});
  final Color accentColor;
